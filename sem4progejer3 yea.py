...
"""
tweet=["@anita123|Lenin Moreno|20/09/2016", "@axell|Guillermo Lasso|21/09/2016","@Josue|Guillermo Lasso|19/09/016","@regatto|Lenin Moreno|18/09/2016","@Paulette|Viteri|16/09/2016","@anita123|Lenin Moreno|21/09/2016","@anita123|Lenin Moreno|20/09/2016"]
...
for registro in tweet:#"@anita123|Lenin Moreno|20/09/2016"
    ...
    if user not in usuarios:
        ...
        posUser=usuarios.index(user)
        fechas[posUser].append(fech)
...
for i in range(len(usuarios)):
    ...
    user=usuarios[i]
    listaFecha=fechas[i]
    for fech in listaFecha:#["20/09/2016","20/'9/2016"]
        if listaFecha.count(fech)>=2 and fech not in mismoDia:
            mismoDia.append(fech)
    if(len(mismoDia)!=0):
        print(user,"los dias son:",mismoDia)
